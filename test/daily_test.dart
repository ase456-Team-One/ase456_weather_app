...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Weather Test App'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  List<DailyTemperature> daily = [DailyTemperature("50")];
  //var dailytempobject = DailyTemperature("50");
  //daily.add(dailytempobject);
